...
For renderer/main-process development in WSL:
...
The production Windows build should run Electron natively and point `API_BASE_URL` to the API in
WSL. The backend remains bound to loopback by default.
...
| `OPENAI_ANSWER_MODEL` | Structured answer model |
